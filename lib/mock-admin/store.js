...
const STORAGE_KEY = "rifex-admin-mockup-v1";
...
export const SEED_DATA = {
  ...
  equipo: [
    { id: "u1", nombre: "Admin Principal", email: "admin@rifex.app", rol: "superadmin", activo: true, ultimo_acceso: hoursAgo(1) },
    { id: "u2", nombre: "Operador Ventas", email: "ventas@rifex.app", rol: "operador", activo: true, ultimo_acceso: hoursAgo(6) },
    { id: "u3", nombre: "Soporte", email: "soporte@rifex.app", rol: "soporte", activo: false, ultimo_acceso: daysAgo(3) },
  ],
  campanas: [
