...
const STORAGE_KEY = "club-gomez-admin-mockup-v2";
  ...
  rifas: [
    {
      ...
      precio_boleto: 90000,
      total_numeros: 10,
      boletos_vendidos: 128,
      created_at: daysAgo(45),
      descripcion: "10 claves con oportunidades · VIP",
      claves: 10,
      premios_anticipados: [],
      numeros_bendecidos: [],
    },
    {
      ...
      precio_boleto: 60000,
      total_numeros: 7,
      boletos_vendidos: 214,
      created_at: daysAgo(45),
      descripcion: "7 claves con oportunidades",
      claves: 7,
      premios_anticipados: [],
      numeros_bendecidos: [],
    },
    {
      ...
      precio_boleto: 30000,
      total_numeros: 3,
      boletos_vendidos: 391,
      created_at: daysAgo(45),
      descripcion: "3 claves con oportunidades",
      claves: 3,
      premios_anticipados: [],
      numeros_bendecidos: [],
    },
  ...
  participantes: [
    {
      ...
      boletos: ["1042", "2891", "5500", "7234", "9100", "1122", "3344", "5566", "7788", "9900"],
    },
    {
      id: "p2",
      rifa_id: "selecto",
      ...
      boletos: ["100", "200", "300", "400", "500", "600", "700"],
    },
    {
      id: "p3",
      rifa_id: "esencial",
    ...
    },
    {
      ...
      boletos: ["11", "22", "33", "44", "55", "66", "77", "88", "99", "101"],
    },
  ],
  beneficiosMes: [
    {
  ...
  actividad: [
    {
      ...
      tipo: "membresia",
      usuario: "Sistema",
      detalle: "Nueva membresía Élite — Carlos Mendoza",
      created_at: hoursAgo(2),
    },
    {
      id: "a2",
      tipo: "pago",
      usuario: "Sistema",
      detalle: "Pago pendiente Selecto — María García",
      created_at: hoursAgo(5),
    },
    {
      id: "a3",
      tipo: "beneficio",
      usuario: "Admin",
      detalle: "Actualizó fechas de motos: 17 y 31 de octubre",
      created_at: daysAgo(1),
    },
    {
      id: "a4",
      tipo: "miembro",
      usuario: "Admin",
      detalle: "Alta presencial Esencial — Juan Pérez",
      created_at: hoursAgo(8),
    },
    {
      id: "a5",
      tipo: "correo",
      usuario: "Sistema",
      detalle: "Correo de claves enviado (Motilón Noche) — Pedro López",
      created_at: daysAgo(2),
    },
  ],
  campanas: [
    ...
    {
      id: "c3",
      nombre: "Recordatorio renovación",
      canal: "whatsapp",
      estado: "borrador",
      enviados: 0,
      abiertos: 0,
  ...
  notificaciones: [
    {
      ...
      mensaje: "María García — plan Selecto pendiente de pago",
      leida: false,
      tipo: "alerta",
    ...
    {
      id: "n2",
      titulo: "Membresías del día",
      mensaje: "12 nuevas activaciones en las últimas 24h",
      leida: false,
      tipo: "info",
    ...
    {
      id: "n3",
      titulo: "Beneficios de octubre",
      mensaje: "Motos programadas: 17 y 31 de octubre",
      leida: true,
      tipo: "success",
      created_at: daysAgo(1),
    },
  ...
  equipo: [
    {
      ...
      email: "admin@clubgomez.com",
      rol: "superadmin",
      activo: true,
      ultimo_acceso: hoursAgo(1),
    },
    {
      id: "u2",
      nombre: "Operador Ventas",
      email: "ventas@clubgomez.com",
      rol: "operador",
      activo: true,
      ultimo_acceso: hoursAgo(6),
    },
    {
      id: "u3",
      nombre: "Soporte",
      email: "soporte@clubgomez.com",
      rol: "soporte",
      activo: false,
      ultimo_acceso: daysAgo(3),
    },
  ],
  automatizaciones: [
    {
      id: "auto1",
      nombre: "Confirmar pago membresía",
      trigger: "pago_confirmado",
      accion: "enviar_claves_correo",
      activa: true,
    },
    {
      id: "auto2",
      nombre: "Recordatorio 24h pendiente",
      trigger: "pago_pendiente_24h",
      accion: "enviar_whatsapp",
      activa: true,
    },
    {
      id: "auto3",
      nombre: "Aviso renovación",
      trigger: "membresia_por_vencer",
      accion: "notificar_miembro",
      activa: false,
    },
  ],
  ventasDiarias: [
...
export function crearVentaFisica(data) {
  ...
  logActividad(
    "venta_fisica",
    `Alta presencial — ${data.nombre} (${data.cantidad_boletos} claves)`
  );
  return participante;
}
...
export function getBeneficiosMes() {
  return loadStore().beneficiosMes || [];
}
