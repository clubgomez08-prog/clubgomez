...
export async function enviarTicketCompra(participante, rifa, boletos) {
  ...
  const appUrl = process.env.NEXT_PUBLIC_APP_URL || "https://rifex.app";
...
<p style="margin:0;font-family:Arial,'Segoe UI',sans-serif;font-size:26px;font-weight:800;color:${C_BG};text-align:center;letter-spacing:0.5px;">¡FELICITACIONES!</p>
</td>
</tr>
<tr>
<td style="padding:28px 24px 8px 24px;font-family:Arial,'Segoe UI',sans-serif;font-size:16px;line-height:1.55;color:${C_TEXT};">
<p style="margin:0 0 20px 0;font-size:18px;">¡<strong>${participante?.nombre || "Ganador"}</strong>, eres el ganador de la rifa!</p>
...
<p style="margin:0 0 12px 0;font-family:Arial,'Segoe UI',sans-serif;font-size:14px;color:${C_TEXT};opacity:0.9;">Tu número ganador</p>
...
<p style="margin:0 0 14px 0;font-size:16px;font-weight:700;color:${C_GOLD};">¿Cómo reclamar tu premio?</p>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:22px;">
<tr><td style="padding:8px 0;font-family:Arial,'Segoe UI',sans-serif;font-size:14px;color:${C_TEXT};line-height:1.6;">1. Responde este correo o contáctanos por WhatsApp</td></tr>
<tr><td style="padding:8px 0;font-family:Arial,'Segoe UI',sans-serif;font-size:14px;color:${C_TEXT};line-height:1.6;">2. Ten a la mano tu documento de identidad</td></tr>
<tr><td style="padding:8px 0;font-family:Arial,'Segoe UI',sans-serif;font-size:14px;color:${C_TEXT};line-height:1.6;">3. Coordinamos la entrega de tu premio</td></tr>
</table>
...
<p style="margin:0 0 24px 0;font-family:Arial,'Segoe UI',sans-serif;font-size:11px;color:${C_TEXT};opacity:0.72;line-height:1.55;">El premio será entregado previa verificación de identidad. RIFEX se reserva el derecho de verificar la autenticidad del boleto ganador.</p>
</td>
</tr>
<tr>
<td style="background-color:${C_NAVY};border:2px solid ${C_GOLD};border-top:none;border-radius:0 0 16px 16px;padding:24px 16px;" align="center">
